...
namespace AargonTools.Manager
{
    public class SetMoveAccount : ISetMoveAccount
    {
        ...
        public SetMoveAccount(ExistingDataDbContext context, ResponseModel response, GetTheCompanyFlag companyFlag, IUserService userService, TestEnvironmentDbContext contextTest)
        {
            _context = context;
