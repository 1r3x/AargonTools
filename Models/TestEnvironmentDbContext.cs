...
{
    public partial class TestEnvironmentDbContext : DbContext
    {
        public TestEnvironmentDbContext()
        {
        }

        public TestEnvironmentDbContext(DbContextOptions<TestEnvironmentDbContext> options)
            : base(options)
        {
        }
