...
namespace AargonTools.Models
{
    ...
    public partial class DebtorAcctInfoP : IDebtorAcctInfo
    {
        [Key]//experimrnt
        [Required]
        [Column("debtor_acct")]
        ...
        [Column("judgment_int_start_date", TypeName = "datetime")]
        public DateTime? JudgmentIntStartDate { get; set; }
        [Column("judgment_int_rate", TypeName = "money")]
        public decimal? JudgmentIntRate { get; set; }
    }
}
