...
namespace AargonTools.Controllers.prod_old
{
    ...
    public class AccountInformationController : ControllerBase
    {
        ...
        /// <summary>
        ///  Returns Next Payment Info.(prod_old)
        /// </summary>
        /// 
        /// <remarks>
        /// **Details**:
        ...
        /// for this endpoint . You can call with an API client like  https://g14.aargontools.com/api/prod_old/AccountInformation/GetNextPaymentInfo/0001-000001
        ...
        public async Task<IActionResult> GetNextPaymentInfo(string clientAcct)
        {
            ...
            {
                //PO for prod_old.
                var item = await _context.GetNextPaymentInfo(clientAcct, "PO");
